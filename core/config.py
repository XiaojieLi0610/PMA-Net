...
data_arg.add_argument(
    #"--data_tr", type=str, default='../data_superpoint/sun3d-superpoint-2000-train.hdf5', help=""
    "--data_tr", type=str, default='/DATASET/SIFT/yfcc-sift-2000-train.hdf5', help=""
    "name of the dataset for train")
data_arg.add_argument(
    #"--data_va", type=str, default='../data_superpoint/sun3d-superpoint-2000-val.hdf5', help=""
    "--data_va", type=str, default='/DATASET/SIFT/yfcc-sift-2000-val.hdf5', help=""
    "name of the dataset for valid")
data_arg.add_argument(
    # "--data_te", type=str, default='../data_superpoint/sun3d-superpoint-512-test.hdf5', help=""
